        ...
        <div data-aos="fade-up" className="about__content">
          <div className="about__title">
            <h1 className="about__title-h1">
              <span className='about__span-sm'>Experience<br/></span>
              <span className='about__span-md'>Clients<br/></span>
              <span className="about__span-lg">Service</span>
            </h1>
          </div>
          <hr className="about__solid-three"></hr>
          <hr className="about__solid-four"></hr>
          <hr className="about__solid-five"></hr>
          ...
          <div className="about__p">
            <div>
              ...
              <hr className="about__solid-one"></hr>
            </div>
            <div>
              ...
              <hr className="about__solid-two"></hr>
            </div>
            <div>
